...
jQuery(document).ready(function($) {
    ...
    $('#contact-submit').click(function () {
        ...
        if (emailVal == "" || emailVal == "Email Address *") {
         ...
         if (contact_subjectVal == '' || contact_subjectVal == 'Mobile *') {
            $('.contact-mobile-error').html('<i class="fa fa-exclamation"></i> Mobile is required.').fadeIn();
            return false;
        }
        ...
        var data_arr;
        data_arr.push('first_name',emailVal);
        data_arr.push('last_name',emailVal);        
        data_arr.push('contact_email',emailVal);
        data_arr.push('message',messageVal); 
        data_arr.push('mobile',mobileVal);         
