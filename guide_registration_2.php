				...
				<div class="panel-body mycontainer"  style="background-color:#dddddd;">
					<form action="guide_registration_code.php" method="POST">
						...
						<div class="row form-group">
							<div class="col-sm-12">
							<strong style="color:#444454;">NIck Name</strong>
							</div>
							<div class="">
								<div class="form-group col-sm-6">
									<input type="text" value="" name="NIckName" id="NIckName" placeholder="First Name" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;"> 
								</div>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-sm-12">
								<strong style="color:#444454;">Licence</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type=radio id="licenceYes" name="licence" checked="true"/> Yes&nbsp;&nbsp;&nbsp;
								<input type=radio id="licenceNo" name="licence" /> No
							</div>
								<div class="">
									<div class="form-group col-sm-6">
										<input type="text" value="" name="LicenceNumber" id="LicenceNumber" placeholder="Licence Number" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;" >
								</div>
								<div class="form-group col-sm-6">
										<input type="text" id="LicenceValidtyDatepicker" placeholder="Licence Validty" style="max-width:155px; height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;">
								</div>
							</div>							
						</div>
						...
						<div class="row form-group">
							<div class="">
								<div class="form-group col-sm-12">
									<input type="file" value="" name="LicenceFilePicker" id="LicenceFilePicker" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 0px gray; padding:0px;" >
								</div>
							</div>
						</div>
		...
		src="js/html5shiv.js"></script> <![endif]-->
		  ...
		  $(function() {
			...
			$('input:radio').change(function() {
				if($("#licenceYes").is(":checked")) 
				{
					$("#LicenceNumber").attr("disabled",false);
					$("#LicenceValidtyDatepicker").attr("disabled",false);
					$("#LicenceFilePicker").attr("disabled",false);
					
					$("#LicenceNumber").css('background-color',"white");
					$("#LicenceValidtyDatepicker").css('background-color',"white");
					$("#LicenceFilePicker").css('background-color',"white");
				}
				if($("#licenceNo").is(":checked")) 
				{
					$("#LicenceNumber").attr("disabled",true);
					$("#LicenceValidtyDatepicker").attr("disabled",true);
					$("#LicenceFilePicker").attr("disabled",true);
					
					$("#LicenceNumber").css('background-color',"#f0f0f0");
					$("#LicenceValidtyDatepicker").css('background-color',"#f0f0f0");
					$("#LicenceFilePicker").css('background-color',"#f0f0f0");
				}
				});
			});
  </script>
