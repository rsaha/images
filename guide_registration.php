...
<html lang="en" dir="ltr">
	...
	<!-- START head --> <head> <!-- Site meta charset --> 
	<meta charset="UTF-8">
	...
	<input type="submit" name="submit" class="search-submit" value="" />
			...
			<div id="main-slider">
				<div id="content-slider">
						<div data-transition="fade" data-slotamount="5" data-masterspeed="700">
							<img src="img/tour_4.jpg" alt="Slider Image 1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" />
						</div>
				</div>
		...
		<!--<div class="row">
			<div class="col-sm-3 col-sm-offset-1">
				<span style="color:#ff845e; font-size:40px;font-family:Pacifico;">Guided Gateway</span>
			</div>
			<div class="col-sm-6 col-sm-offset-1">
				<span style="color:white; font-size:40px;font-family:Brush Script MT;"><center> Authentic Affordable Travel In India</center></span>
			</div>
		</div>
		<br />-->
		<div class="row">
		<div class="mycontainer">
			<div class="col-md-4 col-sm-10 col-sm-offset-1">
				...
				<div class="panel-body mycontainer"  style="background-color:#dddddd;">
					<form action="guide_registration_code.php" method="POST">
						<div class="row form-group">
							<div class="col-sm-12">
							<strong style="color:#444454;">Name</strong>
							</div>
							<div class="">
						...
						<div class="row form-group">
							<div class="col-sm-12">
							<strong style="color:#444454;">Email Address</strong>
							</div>
								<div class="">
						...
						<div class="row form-group">
							<div class="col-sm-12">
								<strong style="color:#444454;">Mobile Number</strong>
							</div>
							<div class="">
								<div class="form-group col-sm-12">
						...
						<div class="row form-group">
							<div class="col-sm-12">
							<strong style="color:#444454;">Create a password</strong>
							</div>
							<div class="">
								<div class="form-group col-sm-12">
						...
						<!-- div class="row form-group">
							...
							<select id="Bmonth" name="Bmonth" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;">
							...
							<div class="form-group col-sm-4">
							<input type="text" value="" id="Bday" name="Bday" maxlength="2" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;" placeholder="Day" >
							</div>
							<div class="form-group col-sm-4">
							<input type="text" value="" id="Byear" name="Byear" maxlength="4" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;" placeholder="Year" >
							</div>
							</div>
						</div>
...
<<<<<<< HEAD
						<div class="row form-group">
							...
							<div class="">
							<div class="form-group col-sm-6">
								<select id="Gender" name="Gender" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;">
						...
						<div class="row form-group">
							<div class="col-sm-12">
						<strong style="color:#444454;">Address</strong>
							</div>
							<div class="">
								<div class="form-group col-sm-12">
								<input type="text" value="" name="StreetAddress" id="StreetAddress" placeholder="Street Address" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;" >
							</div>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="form-group col-sm-6">
							<input type="text" value="" id="City" name="City" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;" placeholder="City" >
							</div>
								<div class="form-group col-sm-6">
									<input type="text" value="" id="State" name="State"class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;" placeholder="State" >
							</div>
							</div>
						
						<div class="row form-group">
							<div class="form-group col-sm-12">
								<select id="Country" name="Country" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;">
						...
						<strong style="color:#444454;"> Prove you’re not a robot </strong>
							<div id="signup-captcha">
								<input type="hidden" id="signuptoken" name="signuptoken" value="03AHJ_VuubLk-sqBCMJXHtxWSRLjFaZ4faRa96vWs9EFAfbeszpoNh6wihY8FYWd_aaxEZUOW0HRapKTPgws856KbCaCuERqWq3b00DZhwvg2jWk5lnvIy-lRcyEhTOSmnUHH9Y6f_xOmB5cfPqocSCkO9R-LHR5iV3nKx_k-wCrGY7uN9A9m9SB_c_PA4W-C8307vzNPZSuLu">
								<input type="hidden" id="signuptoken_audio" name="signuptoken_audio" value="03AHJ_VuubLk-sqBCMJXHtxWSRLjFaZ4faRa96vWs9EFAfbeszpoNh6wihY8FYWd_aaxEZUOW0HRapKTPgws856KbCaCuERqWq3b00DZhwvg2jWk5lnvIy-lRcyEhTOSmnUHH9Y6f_xOmB5cfPqocSCkO9R-LHR5iV3nKx_k-wCrGY7uN9A9m9SB_c_PA4W-C8307vzNPZSuLu">
								<input type="hidden" name="signupcaptchaStats" value="CFCg3nfzMRmBs_itjcJ1-3T_Lo24fSX-3Kg1yBkdTy0:Kr6basqEMngD09K4_rswFg">
								<input type="hidden" name="recaptchaKeyVersion" value="0">
								<span id="recaptcha_challenge_field_holder" style="display: none">
								<input type="hidden" name="recaptcha_challenge_field" id="recaptcha_challenge_field" value="03AHJ_VuubLk-sqBCMJXHtxWSRLjFaZ4faRa96vWs9EFAfbeszpoNh6wihY8FYWd_aaxEZUOW0HRapKTPgws856KbCaCuERqWq3b00DZhwvg2jWk5lnvIy-lRcyEhTOSmnUHH9Y6f_xOmB5cfPqocSCkO9R-LHR5iV3nKx_k-wCrGY7uN9A9m9SB_c_PA4W-C8307vzNPZSuLu">
								</span>
								<div id="recaptcha_widget" class="recaptcha-widget recaptcha_isnot_showing_audio recaptcha_is_building_widget">
									<div id="recaptcha_image">
										<img src="https://www.google.com/recaptcha/api/image?c=03AHJ_VuubLk-sqBCMJXHtxWSRLjFaZ4faRa96vWs9EFAfbeszpoNh6wihY8FYWd_aaxEZUOW0HRapKTPgws856KbCaCuERqWq3b00DZhwvg2jWk5lnvIy-lRcyEhTOSmnUHH9Y6f_xOmB5cfPqocSCkO9R-LHR5iV3nKx_k-wCrGY7uN9A9m9SB_c_PA4W-C8307vzNPZSuLu" width="300" height="57" alt="Visual verification">
									</div>
									<div class="recaptcha-main">
										<label>
										<strong>
										<span id="recaptcha_instructions_image" class="recaptcha_only_if_image" style="color:#444454;">
										Type the text:
										</span>
										
										</strong>
										<input type="text" id="recaptcha_response_field" name="recaptcha_response_field" class="form-control" style="height:30px; background-color:white; color:black; -moz-border-radius: 10px; border-radius: 2px; border:solid 1px gray; padding:5px;" >
										</label>
										<div class="recaptcha-buttons">
											<a id="recaptcha_reload_btn" href="javascript:Recaptcha.reload()" title="Get a new challenge">
											<span style="color:#444454;">
											Get a new challenge
											</span>
											</a>
											
											<a id="recaptcha_whatsthis_btn" target="_blank" href="https://www.google.com/recaptcha/help" title="Help">
											<span>Help</span>
											</a>
										</div>
									</div>
