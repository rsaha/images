                                    ...
                                    <div class="tab-content clearfix ">
                                        ...
                                        <div class="tab-pane active" id="createTour">
                                            <div class="booking gray clearfix box-shadow1">
                                                <div class="col-sm-6">
                                                    <h2 class="">Upload your tour media here</h2>
                                                    <br>
                                                    <?php
												...
												?>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" tabindex="4" placeholder="Tour Discription" name="tourDiscription" style="height:115px; background-color:white" required>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Enter region of tour">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" tabindex="10" placeholder="Inclusive" name="inclusive" style="background-color:white" required>
                                                                <?php echo $inclusive; ?>
                                                            </textarea>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" tabindex="11" placeholder="Exclusive" name="exclusive" style="background-color:white" required>
                                                                <?php echo $exclusive; ?>
                                                            </textarea>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" tabindex="12" placeholder="Cancellation Policy" name="cancellationPolicy" style="background-color:white" required>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" tabindex="13" placeholder="Restriction" name="restriction" style="background-color:white">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <strong> Notes:</strong>
                                                            <textarea class="form-control" tabindex="14" placeholder="Notes" name="notes" style="background-color:white">
                                                                <?php echo $notes; ?>
                                                            </textarea>
