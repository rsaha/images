									...
									<center><h3>Invite your 3 friends by their email id and get some exciting offers...</h3></center><br />
										...
										<input type="hidden" name="userid" value="<?php echo $userid ?>" />
											...
											<div class="col-md-4">
															...
															<input type="text" class="form-control" name="nameFriend1" value="" required pattern="[a-z A-Z]+" />
														</div>
														<div class="col-md-4">
															<label>Email Id of your 1st friend</label>
															<input type="email" class="form-control" name="emailFriend1" value="" required pattern="^[a-zA-Z0-9._]+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$"/>
														</div>
														<div class="col-md-4">
															<label>Mobile Number of your 1st friend</label>
															<input type="tel" class="form-control" name="mobileFeiend1" value="" required pattern="\d{10}"/>
														</div>
													...
													<li class="row">
														<div class="col-md-4">
															...
															<input type="text" class="form-control" name="nameFriend2" value="" required pattern="[a-z A-Z]+" />
														</div>
														<div class="col-md-4">
															<label>Email Id of your 2nd friend</label>
															<input type="email" class="form-control" name="emailFriend2" value="" required pattern="^[a-zA-Z0-9._]+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$"/>
														</div>
														<div class="col-md-4">
															<label>Mobile Number of your 2nd friend</label>
															<input type="tel" class="form-control" name="mobileFeiend2" value="" required pattern="\d{10}" />
														</div>
