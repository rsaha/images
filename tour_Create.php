						...
						?>
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <br>
                                        <br />
                                        <span style="font-size:18px;font-weight:bold;"><?php echo $licenceNumber ?></span>
                                        <br />
                                        <hr>
                                        <label style="font-size:14px;">Licence Expiry Date :</label>
                                        <br>
                                        <br />
                                        <span style="font-size:18px;font-weight:bold;"><?php echo $licenceValidty ?></span>
                                        <br />
                                        <hr>
                                                ...
                                                <form method="post" action="tour_Create_Code.php">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Please select tour type.">
												...
												?>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Location">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Enter Tour name here">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Short description of the tour in 10 sentences">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <strong> Tour Territory:</strong>
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Enter your name here">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Duration. ex. 2 days">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Price per person or tail price. ex. INR 1500 per person">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Pickup Point. i.e. Delhi Airport">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Drop Off. i.e. Delhi Central">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Tour price includes. ex. Transport , All meals, entree fees">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Tour prices excludes ex. shopping, drinks">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Cancellation Policy. ex. full-refund if cancelled 7 days before tour begins">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Mention Restriction if any.">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <strong> Notes:</strong>
                                                            <a class="pull-right" tabindex="0" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="Any other special notes">
                                                                <i class='fa fa-info-circle' style="color:gray"></i>
                                                            </a>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-3 col-sm-offset-3">
                                                            <a onclick="backtoProfile(<?php echo $userid; ?>)">
                                                                <button tabindex="16" class="form-control btn btn-default">Cancel</button>
                                                            </a>
                                                        </div>
                                                        <div class="col-sm-3">
